...
print(f"Conta criada: {minha_conta.numero_conta}, Saldo inicial: R$ {minha_conta.saldo:.2f}")
 
# Criando outra conta para demonstrar a independência
conta_joao = ContaBancaria(numero_conta="67890-Y")
print(f"Conta do João: {conta_joao.numero_conta}, Saldo inicial: R$ {conta_joao.saldo:.2f}")
...
if __name__ == "__main__":
    ...
    minha_conta = ContaBancaria(numero_conta="987654-1", saldo_inicial=500.0)
    ...
    minha_conta.sacar(150)         # Permite ao usuário sacar um valor da conta.
    minha_conta.consultar_saldo()  # Exibe o saldo atual da conta.
    ...
    def exibir_extrato(self):
        ...
        if not self.extrato:  # Verifica se o extrato está vazio
            ...
            print("\n--- Extrato Bancário ---")
            for transacao in self.extrato:  # Iterar sobre a lista extrato e exibir cada transação formatada
    ...
    def transferir(self, conta_destino, valor):
        """ Realiza uma transferência de valor para outra conta bancária. """
         try:
            ...
            if not isinstance(conta_destino, ContaBancaria):  # Verifica se realmente é conta de destino                    print("Erro: A conta de destino não é válida de ContaBancaria.")
                return
